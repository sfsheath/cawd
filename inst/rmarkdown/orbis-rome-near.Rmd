...
set.vertex.attribute(o.nw,name = "x", index = as.character(orbis.nodes$id), value = orbis_nodes$x) -> o.nw
set.vertex.attribute(o.nw,name = "y", index = as.character(orbis.nodes$id), value = orbis_nodes$y) -> o.nw
