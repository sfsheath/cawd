---
title: "Heatmap of Archaeologically Attested Rat Remains (AD 1-500)"
...
ggplot(as.data.frame(darmc.rats.1to500.sp[darmc.rats.1to500.sp$latitude > 0,]), aes(x = longitude, y = latitude))  +
  coord_map() +
